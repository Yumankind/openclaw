...
import {
  ...
  type WakeParams,
  WakeParamsSchema,
  type WebLoginCodeStartParams,
  WebLoginCodeStartParamsSchema,
...
export const validateWebLoginCodeStartParams =
  ajv.compile<WebLoginCodeStartParams>(WebLoginCodeStartParamsSchema);
